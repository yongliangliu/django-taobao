    ...
    verify(
        [
               {id: '#nick_name', tips: Dml.Msg.epNickName, require: true},
                {id: '#alipay_id', tips: Dml.Msg.epAlipayId, require: true},
                {id: '#qq', tips: Dml.Msg.epQQ, require: true},
                {id: '#mobile', tips: Dml.Msg.epTel, require: true},
    ...
    $('#jsEditUserBtn').on('click', function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                }else if(data.alipay_id){
                   _showValidateError($('#alipay_id'), data.alipay_id);
                }else if(data.status == "failure"){
                     Dml.fun.showTipsDialog({
                        title: '保存失败',
                        h2: data.msg
